...
export const dict = {
  en: {
    ...
    apply: {
      ...
      closedImageAlt: "Love Potion editorial portrait",
      closedCardKicker: "No open spots today",
      closedCardTitle: "Stay close to the potion.",
      closedCardBody:
        "Applications are closed, but the house is still glowing. Follow new releases, visit the shop, and check back when the next blogger call opens.",
      closedPrimary: "Visit the shop",
      closedSecondary: "See releases",
      sl: "SL avatar name",
      mail: "Contact email",
      flickr: "Flickr URL",
  ...
  es: {
    ...
    apply: {
      ...
      closedImageAlt: "Retrato editorial de Love Potion",
      closedCardKicker: "Sin cupos abiertos hoy",
      closedCardTitle: "Quédate cerca de la poción.",
      closedCardBody:
        "Las aplicaciones están cerradas, pero la casa sigue brillando. Mira los nuevos lanzamientos, visita la tienda y vuelve cuando abramos la próxima llamada para bloggers.",
      closedPrimary: "Visitar tienda",
      closedSecondary: "Ver lanzamientos",
