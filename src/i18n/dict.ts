...
export const dict = {
  en: {
    ...
    login: {
      ...
      forgotIntro: "Enter the email connected to your blogger account.",
      forgotCta: "Send recovery link",
      forgotSending: "Sending...",
      forgotSent:
        "If this email belongs to an account, you will receive a recovery link shortly. Check your spam folder too.",
      ...
      resetLength: "The password must have at least 8 characters.",
      loading: "Opening...",
      handwritten: "welcome",
  ...
  es: {
    ...
    login: {
      ...
      forgotIntro: "Escribe el email conectado a tu cuenta de blogger.",
      forgotCta: "Enviar enlace de recuperación",
      forgotSending: "Enviando...",
      forgotSent:
        "Si este email pertenece a una cuenta, recibirás un enlace de recuperación pronto. Revisa también la carpeta de spam.",
      ...
      resetLength: "La contraseña debe tener al menos 8 caracteres.",
      loading: "Abriendo...",
