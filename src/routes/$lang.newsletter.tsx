  ...
  return (
    <main className="px-6 pt-16 md:px-12">
      <div className="mx-auto max-w-[1300px]">
        ...
        <p className="mt-6 max-w-xl text-lg text-foreground/80">{t.newsletter.kicker}</p>
          ...
          <div>
            ...
            <GlassCard className="mt-4 overflow-hidden p-0">
              ...
              <div className="p-6">
                ...
                <h3 className="mt-2 font-display text-2xl">{t.newsletter.sampleTitle}</h3>
                <p className="mt-2 text-sm text-foreground/75">{t.newsletter.sampleBody}</p>
              </div>
            </GlassCard>
          </div>
        </div>
