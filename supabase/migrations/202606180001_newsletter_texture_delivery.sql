-- Newsletter texture delivery support.
-- Lets staff enter the exact texture item name stored in the Second Life delivery prim.

alter table public.newsletter_campaigns
  add column if not exists sl_texture_item_name text;
...
begin
  ...
  select
    ...
    case
      ...
      else campaign_body || E'\n\nPhoto fallback: ' || campaign_image_url
    end,
