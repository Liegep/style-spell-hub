-- Make new application notifications read naturally in-app and in Second Life.
-- Prefer the applicant's name and avoid empty "from ." messages.
...
begin
  ...
  notification_body := 'New application: ' || applicant_name || '. Open Applications in Love Potion HQ.';
